...
# ✅ NUEVO: Capítulos del libro (para el lector con scroll infinito)
class Capitulo(models.Model):
    id_capitulo = models.AutoField(primary_key=True)
    libro = models.ForeignKey(Libro, models.CASCADE, related_name='capitulos')
    numero = models.PositiveIntegerField()
    titulo = models.CharField(max_length=200)
    contenido = models.TextField()
    palabras = models.PositiveIntegerField(default=0, blank=True)
    ...
    def save(self, *args, **kwargs):
        if self.contenido:
            self.palabras = len(self.contenido.split())
